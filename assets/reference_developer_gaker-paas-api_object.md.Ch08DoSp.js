import{_ as i,c as a,a1 as n,o as p}from"./chunks/framework.D74g-0xE.js";const u=JSON.parse('{"title":"应用信息","description":"","frontmatter":{},"headers":[],"relativePath":"reference/developer/gaker-paas-api/object.md","filePath":"reference/developer/gaker-paas-api/object.md"}'),t={name:"reference/developer/gaker-paas-api/object.md"};function l(h,s,e,k,E,o){return p(),a("div",null,s[0]||(s[0]=[n(`<h1 id="应用信息" tabindex="-1">应用信息 <a class="header-anchor" href="#应用信息" aria-label="Permalink to &quot;应用信息&quot;">​</a></h1><h2 id="获取应用列表" tabindex="-1">获取应用列表 <a class="header-anchor" href="#获取应用列表" aria-label="Permalink to &quot;获取应用列表&quot;">​</a></h2><p>请求接口：<code>/v1/open/object/list</code></p><p>请求方法：<code>POST</code></p><p>请求参数：无</p><p>响应数据：</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ],</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">    &quot;msg&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;success&quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,46)]))}const r=i(t,[["render",l]]);export{u as __pageData,r as default};
