import{_ as i,c as a,a1 as n,o as t}from"./chunks/framework.aDewEmSk.js";const d=JSON.parse('{"title":"数据字典","description":"","frontmatter":{},"headers":[],"relativePath":"reference/developer/gaker-paas-api/dict.md","filePath":"reference/developer/gaker-paas-api/dict.md"}'),p={name:"reference/developer/gaker-paas-api/dict.md"};function e(l,s,h,o,k,r){return t(),a("div",null,s[0]||(s[0]=[n(`<h1 id="数据字典" tabindex="-1">数据字典 <a class="header-anchor" href="#数据字典" aria-label="Permalink to &quot;数据字典&quot;">​</a></h1><h3 id="获取国家区号" tabindex="-1">获取国家区号 <a class="header-anchor" href="#获取国家区号" aria-label="Permalink to &quot;获取国家区号&quot;">​</a></h3><p>请求接口：<code>/v1/open/base/countryCode</code></p><p>请求方法：<code>GET</code></p><p>请求参数：无</p><p>响应数据：</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
</code></pre>`,14)]))}const u=i(p,[["render",e]]);export{d as __pageData,u as default};
